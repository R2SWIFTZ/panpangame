...
export default function HomeHero({ availableCount }: { availableCount: number }) {
  return (
    <section className="relative overflow-hidden border-b border-line bg-grid">
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-14 text-center sm:py-18">
        <motion.p
        ...
        <motion.h1
          ...
          className="mx-auto mt-5 max-w-2xl font-display text-4xl leading-tight sm:text-5xl"
        >
          รหัส <span className="text-pink">Free Fire</span> คัดคุณภาพ
          <br className="hidden sm:block" /> ส่งไว ปลอดภัย
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 24 }}
          animate={{ opacity: 1, y: 0 }}
